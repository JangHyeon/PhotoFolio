...
public class profileimgUpLoadAction implements Action {
	@Override
	public ActionForward execute(HttpServletRequest request,
        ...
        */
	    String savedir = "storage/profile"; //저장 폴더명
...
//--------------------------------업로드 끝-----------------------------------------------------------
		...
		String result = ThumbnailCreater.profilecropAndResize(pathname+File.separator+FilesystemName);
		System.out.println("result---------"+result);//------------------Image 후처리----------
