...
import com.photofolio.Action.IdchkAction;
...
import com.photofolio.Action.NickAction;
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(command.equals("/memberorder/joinprocess"))
		{
			...
			try {
	         ...
	         }else if(command.equals("/memberorder/idchkprocess")){
	         ...
	         }else if(command.equals("/memberorder/nickchkprocess")){
	        	 String nickname = request.getParameter("nickname");
	        	 System.out.println("aaaaaaaaaaaaa"+nickname);
