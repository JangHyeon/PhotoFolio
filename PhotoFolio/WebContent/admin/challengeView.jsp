	...
	<div id="page">
		...
		<div id="main" align="center">
			...
			<form action="../adminorder/ChallengeWrite" method="post">
				...
				%>
				<div>
					<input type="text" size="80px" name="subject"
						value="<%=challenge.getSubject()%>" readonly="readonly"><br>
					<input type="text" size="48px" name="startdate"
						value="<%=challenge.getStartdate()%>" readonly="readonly">
					-<input type="text" size="48px" name="enddate"
						value="<%=challenge.getEnddate()%>" readonly="readonly"><br>
					<textarea name="content" rows="" cols="90px" readonly="readonly"><%=challenge.getContent()%></textarea>
					<br> <br>
				</div>
				...
				<div>
					엠블럼 사진 등록하는 것 일단보류<br> <input type="text" name="emblem"
						value="<%=challenge.getEmblem()%>" readonly="readonly">
				</div>
