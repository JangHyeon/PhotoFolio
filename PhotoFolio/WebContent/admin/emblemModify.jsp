...
%>
				<form action="../adminorder/emblemModifyOk?emblem_no=<%= emblem.getEmblem_no()%>" method="post">
				<div>
					엠블럼 사진 등록하는 것 일단보류<br> 
					<input type="text" name="emblem"  value="<%=emblem.getEmblem() %>">
				</div>
<%} %>			
				<div>
				<a href="../adminorder/emblemManeger">뒤로가기</a>
