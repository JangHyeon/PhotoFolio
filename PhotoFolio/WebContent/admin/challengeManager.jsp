		...
		<div id="main" align="center">
			...
			<table style="width: 900px; border: 1px solid; text-align: center;">
				...
				<tr>
					...
					<td><a
						href="../adminorder/challengeView?emblem_no=<%=challenge.getEmblem_no()%>">보기</a></td>
					<td><a
						href="../adminorder/challengeModify?emblem_no=<%=challenge.getEmblem_no()%>">수정</a></td>
					<td><a
						href="../adminorder/challengeDelete?emblem_no=<%=challenge.getEmblem_no()%>">삭제</a></td>
				</tr>
				<%
					}
				%>
