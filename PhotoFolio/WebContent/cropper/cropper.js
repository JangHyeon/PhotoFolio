...
(function(factory) {
    ...
    Cropper.prototype = {
        ...
        resize: function() {
            ...
            this.resizing = setTimeout($.proxy(this.rerender, this), 100);
        },
        ...
        addListener: function() {
        	//더블클릭 이벤트 추가
            this.$cropper.bind("dblclick", $.proxy(this.dclick, this));
    ...
    Cropper.template = [
        '<div class="cropper-container">',
	        ...
	        '<div class="cropper-modal-title"><span>선택한 영역을 <em>더블클릭</em> 해주세요</span></div>',
	        '<div class="cropper-modal-title-bg"></div>',
