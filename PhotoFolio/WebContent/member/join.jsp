...
$("#nickchk").click(function(){
	var nickname = {nickname:$('#nicknametxt').val()};
$.ajax({
    url : '../memberorder/nickchkprocess',
	    data:nickname,
...
<body>
   <div id="page">
      ...
      <form name="joinform" id="joinform" action="../memberorder/joinprocess" method="post"> 
         아이디: <input type="text" id="id" name="id" >
         <button   id="idchk" type="button">중복체크</button>
          <input type="text" name="idhidden" id="idhidden" hidden="hidden"><br>
    
         비밀번호 : <input type="password" name="pwd"><br>
         닉네임 : <input type="text" id="nicknametxt" name="nicknametxt">
         
          <button   id="nickchk" type="button">중복체크</button><br>
                        <input type="text" name="nickhidden" id="nickhidden" hidden="hidden"><br>
              
         휴대폰번호 : <input type="text" name="phone"><br>
         이메일 : <input type="text" name="email"><br>
         주소 : <input type="text" name="address"><br>
         프로필이미지 : <br><input type="image" src="WebContent/images/bg_thmb_blank3.gif">
                  <input type="button" value="이미지 업로드" name="imgbtn"><br>
         <br>
         프로필 : <br><textarea rows="10" cols="30"name="profile" style="resize:none; overflow-y:scroll;"></textarea>
         <br>
         
         이용약관 동의 : <input type="checkbox" id="chkbox" name="chkbox"> 
         
         
         
         <a href="javascript:void(0)" 
         onclick="document.getElementById('light').style.display='block';document.getElementById('fade').style.display='block'">이용약관보기</a><br>
      
      <!-- 이용약관 보기 -->
         <div id="light" class="white_content"> 
         제 1 조 (목적)
이 약관은 네이버 주식회사("회사")가 제공하는 그라폴리오(www.grafolio.net) 및 그라폴리오 관련 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
제 2 조 (정의)
이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
①"서비스"라 함은 구현되는 단말기(PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 "회원"이 이용할 수 있는 그라폴리오(grafolio.net) 및 그라폴리오 관련 제반 서비스를 의미합니다.
...
부칙
①이 약관은 2014년 3월 19일부터 적용됩니다.
②2013년 12월 26일부터 시행되던 종전의 약관은 본 약관으로 대체합니다.
         
         <a href="javascript:void(0)" onclick="document.getElementById('light').style.display='none';document.getElementById('fade').style.display='none'"><h2>[[[[닫기]]]]</h2></a></div>
         <div id="fade" class="black_overlay"></div>
         
 <a href="#" id="joinchk">회원가입</a>&nbsp;&nbsp;
